<div class="container-fluid" id="addproduct-body">
    ...
    <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12" id="addproduct-content">
		<div>
			...
			<input type="text" id="name" placeholder="Xiaomi MI5">
		</div>
		<div>
			<label for="sm-description"><span class="glyphicon glyphicon-tags"></span> Small description</label>
			<textarea rows="5" id="sm-description" placeholder="MIUI 8 4GB RAM Snapdragon 820 64bit Quad Core 2.15GHz 16.0MP + 4.0MP Cameras Type-C Quick Charge 3.0 NFC Front Fingerprint Sensor 3D Ceramic Body"></textarea>
		</div>
		<div>
		...
		<div>
			...
			<input type="number" id="price" placeholder="375.42">
		</div>
		<div>
		...
		<div>
			...
			<input type="number" id="qty" placeholder="60">
		</div>
		<div>
		...
		<div>
			...
			<textarea rows="10" maxlength="5" id="lg-description" placeholder="MIUI 8 4GB RAM Snapdragon 820 64bit Quad Core 2.15GHz 16.0MP + 4.0MP Cameras Type-C Quick Charge 3.0 NFC Front Fingerprint Sensor 3D Ceramic Body"></textarea>
		</div>
		<div>
			<button id="addbutton" type="button" class="btn btn-primary btn-block profileButton">Edit</button>
		</div>
    </div>
</div>